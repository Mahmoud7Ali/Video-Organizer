...
public class AddFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        addframeclose = new javax.swing.JLabel();
        ...
        addPanel.add(VidedoName, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 184, 33));
        addPanel.add(VideoPath, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 70, 184, 33));
        addPanel.add(VideoAction, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 184, 33));
        addPanel.add(VidPlayerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 184, 33));
        ...
        addPanel.add(Home_Team, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 220, 184, 33));
        ...
        addPanel.add(addOK, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 330, 90, -1));
        ...
        addPanel.add(Away_Team, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 270, 184, 33));
        ...
        addPanel.add(AwayTeamLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, 140, 30));
        ...
        addPanel.add(VidNameLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, 140, 30));
        ...
        addPanel.add(VidPathLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 140, 30));
        ...
        addPanel.add(VidCategoryLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 140, 30));
        ...
        addPanel.add(SpPlayerLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 140, 30));
        ...
        addPanel.add(HomeTeamLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, 140, 30));

        addframeclose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/videoplayer/close.png"))); // NOI18N
        addframeclose.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                addframecloseMouseClicked(evt);
            }
        });
        addPanel.add(addframeclose, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 0, 30, 30));

        getContentPane().add(addPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 540, 420));

        setSize(new java.awt.Dimension(532, 412));
    ...
    private void addOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addOKActionPerformed
        ...
        Link.LS.add(VidName,Path,Action,PlayerName,Team1,Team2);
        try{
                //call jdbc
                ...
                stm.executeUpdate("insert into Video values('"+VidName+"','"+Path+"',"
                        + "'"+Action+"','"+PlayerName+"','"+Team1+"','"+Team2+"')");
    ...
    private void addframecloseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addframecloseMouseClicked
        // TODO add your handling code here:
        this.setVisible(false);
    }//GEN-LAST:event_addframecloseMouseClicked
    ...
    private javax.swing.JLabel addframeclose;
